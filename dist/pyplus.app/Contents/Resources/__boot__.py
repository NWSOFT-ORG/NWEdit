...
_path_inject(['/Applications/OneDrive-Sync.app/Contents/MacOS/.PyPlusSource'])
...
DEFAULT_SCRIPT='/Applications/OneDrive-Sync.app/Contents/MacOS/.PyPlusSource/PyPlus.py'
SCRIPT_MAP={}
try:
    _run()
