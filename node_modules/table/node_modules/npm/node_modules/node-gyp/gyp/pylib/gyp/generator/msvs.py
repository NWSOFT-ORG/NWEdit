...
def _EscapeEnvironmentVariableExpansion(s):
    ...
    See http://connect.microsoft.com/VisualStudio/feedback/details/106127/cl-d-name-text-containing-percentage
    -characters-doesnt-compile
...
def _CollapseSingles(parent, node):
    ...
    if type(node) == dict and len(node) == 1 and list(node)[0] == parent + ".vcproj":
