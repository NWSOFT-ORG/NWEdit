...
def ReadUnicodeTable(filename, nfields, doline):
    ...
    for line in fil:
        ...
        try:
            ...
            if len(fields) != nfields:
                raise InputError(
                    "wrong number of fields %d %d - %s" % (len(fields), nfields, line)
                )
            ...
            if expect_last is not None:
                ...
                if (
                    ...
                    raise InputError("expected Last line for %s" % (expect_last,))
    ...
    if expect_last is not None:
        raise InputError("expected Last line for %s; got EOF" % (expect_last,))
