...
class Editor:
	...
	def __init__(self):
        ...
        * The file selector does not work.
		...
		self.master.bind(f'<{_MAIN_KEY}-Shift-Tab>',
		                 lambda _=None: self.indent('unindent'))
		self.master.bind(f'<{_MAIN_KEY}-Tab>',
		                 lambda _=None: self.indent('indent'))
